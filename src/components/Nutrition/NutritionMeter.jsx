      ...
      <div className="container mx-auto p-4">
        ...
        <div className="mb-4">
          <div className="grid grid-cols-2 gap-4 w-full max-w-md mx-auto">
            <input
              ...
              className={`h-full w-full py-2 border-b border-blue-gray-200 bg-transparent pt-4 pb-1.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border-blue-gray-200 focus:border-gray-900 focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50 ${
          ...
          <div className="mt-3 flex justify-between w-full max-w-md mx-auto">
            {editItem ? (
              <button
                className="bg-[#0A369D] text-white p-3 rounded-md hover:bg-blue-600 mb-4
              ...
              <button
                className="bg-[#4F4789] text-white p-3 rounded-md hover:bg-[#7264DC] mb-4
                  font-semibold focus:outline-none text-xs"
            ...
            <button
              className="bg-[#005E7C] text-white p-3 rounded-md font-semibold mb-4 hover:bg-[#1083A9] 
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
          {nutritionItems.map((item) => (
            <div
              key={item.id}
              className="bg-[#C7FFDA] p-4 rounded-md shadow-md border-2 border-blue-400 
			hover:border-blue-500 hover:shadow-lg transition transform hover:scale-105 text-center"
            >
              ...
              <ul className="mt-3">
                ...
                <li className="flex items-center mt-2">
                  <button
                    className="bg-[#514663] text-white hover:bg-[#67597D] p-2 rounded-md font-semibold"
                  ...
                  <button
                    className="bg-[#a8201a] text-white hover:bg-red-600 p-2 rounded-md font-semibold"
                    onClick={() => updateItemQuantity(item.id, -1)}
                  >
              ...
              <div className="mt-3 flex justify-between">
                <button
                  className="bg-[#5E7CE2] text-white pd-2 h-10 rounded-md hover:bg-[#0A369D] 
				font-semibold focus:outline-none text-xs"
                ...
                <button
                  className="bg-[#5A0001] text-white pd-2 rounded-md hover:bg-[#9B0F11] 
				font-semibold focus:outline-none text-xs"
        ...
        <table className="mt-8 text-center w-full border border-[#5A0001]">
          <thead>
            <tr className="text-xl font-semibold border border-[#5A0001]">
              <th className="border border-[#5A0001]">Total Calories</th>
              <th className="border border-[#5A0001]">Total Protein (g)</th>
              <th className="border border-[#5A0001]">Total Carbs (g)</th>
              <th className="border border-[#5A0001]">Total Fat (g)</th>
            </tr>
          </thead>
          <tbody>
            <tr className="text-xl font-semibold">
              <td className="border border-[#5A0001]">
                {totalCalories}{" "}
                <span id="nutrition-icon">
                  <FontAwesomeIcon icon={faUtensils} size="lg" />
                </span>
              </td>
              <td className="border border-[#5A0001]">{totalProtein()}</td>
              <td className="border border-[#5A0001]">{totalCarbs()}</td>
              <td className="border border-[#5A0001]">{totalFat()}</td>
            </tr>
          </tbody>
        </table>
      </div>
